...
public class ListCommandTest {
    ...
    @BeforeEach
    public void setUp() {
        model = new ModelManager(getTypicalExerciseBook(), new ReadOnlyResourceBook<>(REGIME_ASCENDING_NAME_COMPARATOR),
        ...
        expectedModel = new ModelManager(model.getExerciseBookData(), new ReadOnlyResourceBook<>(REGIME_ASCENDING_NAME_COMPARATOR),
                 new ReadOnlyResourceBook<>(EXERCISE_DESCENDING_DATE_COMPARATOR),
                new ReadOnlyResourceBook<>(SCHEDULE_ASCENDING_DATE_COMPARATOR), new UserPrefs(),
            getDefaultPropertyBook());
    }
