...
* Note that you will not be allowed to schedule a regime before the date displayed on your system clock
* Note that you are allowed to schedule a regime of the same name on the same date. The resolve window will pop up for you as per normal.
****
Example 1:
...
* `schedule n/cardio d/02/03/2010`

Assuming that your system clock is after the date `02/03/2010`, `ExerHealth` will not allow the regime `cardio` to be scheduled on the inputted date of `02/03/2010`.

Expected Result:

image::ScheduleBeforeTodayDate.png[]
